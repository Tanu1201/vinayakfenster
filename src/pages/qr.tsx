...
export default function Home() {
  return (
    <div className="min-h-[100dvh] gap-12 flex justify-center items-center flex-col bg-white text-black">
      <h1 className={`text-5xl ${comic.className}`}>D_signer&apos;s Space</h1>
      <div className="grid grid-cols-2 gap-24 gap-y-8 mt-12">
        <Link
          href="https://www.facebook.com/Designersspc?mibextid=LQQJ4d"
        ...
        <Link
          href="https://maps.app.goo.gl/uhkSWxywGaaQQqU59"
          className="flex flex-col items-center"
        >
